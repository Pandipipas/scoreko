...
import { getCountryOptions } from '../../../shared/countries';
...
const defaultCountryOptions = computed(() => [
  { label: t('settingsDefaultCountryNone'), value: '' },
  ...getCountryOptions(locale.value),
]);

const filteredCountryOptions = ref(defaultCountryOptions.value);

watch(defaultCountryOptions, (options) => {
  filteredCountryOptions.value = options;
});

const filterCountryOptions = (val: string, update: (cb: () => void) => void) => {
  update(() => {
    const needle = val.toLowerCase().trim();
    filteredCountryOptions.value = needle
      ? defaultCountryOptions.value.filter((c) => c.label.toLowerCase().includes(needle))
      : defaultCountryOptions.value;
  });
};
  ...
  <QPage class="settings-page">
    <div class="settings-layout">
      ...
      >
        ...
        >
          <div class="row q-col-gutter-lg">
            <div class="col-12 col-lg-6 column q-gutter-y-lg">
              <QCard
                class="glass-panel settings-card dashboard-stagger-1"
              >
                <QCardSection>
              ...
              <QCard
                class="glass-panel settings-card dashboard-stagger-2"
              >
                <QCardSection>
                  <div class="row items-center q-gutter-md">
                    <div class="col">
                      <div class="text-subtitle1 text-weight-medium">
                        {{ t('settingsDefaultCountryLabel') }}
                      </div>
                      <div class="text-caption text-grey-6">
                        {{ t('settingsDefaultCountryHint') }}
                      </div>
                    </div>
                    <div class="col-auto">
                      <QSelect
                        v-model="graphicsSettingsStore.defaultCountry"
                        emit-value
                        map-options
                        use-input
                        hide-selected
            ...
            <div class="col-12 col-lg-6 dashboard-stagger-3">
              <QCard
                class="glass-panel settings-card full-height column"
              >
                <QCardSection>
        ...
        >
          <div class="row q-col-gutter-lg">
            <div class="col-12 col-lg-6 dashboard-stagger-1">
              <QCard class="glass-panel settings-card full-height column">
                <QCardSection>
                  <div class="row items-center q-mb-md q-gutter-x-sm">
                    ...
                    <div class="row q-gutter-sm items-center">
                      <QBtn
                        ...
                        tabindex="-1"
                        style="pointer-events: none; padding: 4px 16px;"
                      />
                      <QBtn
                        v-if="!startgg.hasTokenConfigured"
            ...
            <div class="col-12 col-lg-6 dashboard-stagger-2">
              <QCard class="glass-panel settings-card full-height column">
                <QCardSection>
                  <div class="row items-center q-mb-md q-gutter-x-sm">
                    <img
