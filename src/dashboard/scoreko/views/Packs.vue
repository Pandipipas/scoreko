...
const requestUninstallPack = async (pack: PackRegistryEntry) => {
  const confirmed = await confirmAction({
    title: t('packsUninstallBtn'),
    message: t('packsUninstallConfirmMessage').replace('{name}', pack.name),
    destructive: true
  });
  if (!confirmed) return;
...
<template>
  <QPage class="packs-page">
    <div
      ...
      class="flex flex-center q-py-xl dashboard-stagger-1"
    >
    ...
    >
      ...
      >
        <QCard
          class="glass-panel filter-card q-mb-md dashboard-stagger-1"
        >
        ...
        <QCard
          class="glass-panel list-card dashboard-stagger-2"
        >
          <div
              ...
              <QItemSection avatar>
                ...
                >
                  <img
                    ...
                    class="pack-mini-header img-fade-in"
                    alt=""
                    loading="lazy"
                    decoding="async"
                  ...
                  <img
                    ...
                    class="pack-mini-logo img-fade-in"
                    alt=""
                    loading="lazy"
                    decoding="async"
      ...
      >
        <QCard
          v-if="!selectedPack"
          class="glass-panel empty-detail-card flex flex-center dashboard-stagger-3"
        >
        ...
        <QCard
          v-else
          class="glass-panel detail-card dashboard-stagger-3"
        >
          ...
          <div
            class="detail-banner"
            :class="{ 'detail-banner--loading': heroSrc && !heroError && !heroLoaded }"
            :style="{
          ...
          >
            <img
              ...
              :src="heroSrc"
              class="banner-bg-img"
              :class="{ 'banner-bg-img--loaded': heroLoaded }"
              alt=""
              decoding="async"
            ...
            <div class="banner-content-layer">
              ...
              >
                <img
                  ...
                  :src="logoSrc"
                  class="detail-logo"
                  :class="{ 'detail-logo--loaded': logoLoaded }"
                  alt=""
                  decoding="async"
                  ...
                  >
                    <div class="char-avatar-container">
                      ...
                      <img
                        ...
                        class="char-avatar-img img-fade-in"
                        alt=""
                        decoding="async"
