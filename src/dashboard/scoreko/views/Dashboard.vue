...
<template>
  <QPage class="q-px-lg q-pb-lg dashboard-page">
    <div class="dashboard-grid">
      <div class="dashboard-banner-row dashboard-stagger-1">
        <ScoreboardBanner />
      </div>
      
      <div class="dashboard-controls-row dashboard-stagger-2">
      ...
      <div class="dashboard-bottom-row dashboard-stagger-3">
        <QCard class="dashboard-panel-card glass-panel">
          <QCardSection class="dashboard-panel-content">
            <CommentaryPanel />
          </QCardSection>
