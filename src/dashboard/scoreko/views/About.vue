  ...
  <QPage class="about-page">
    <div class="about-layout">
      ...
      >
        ...
        >
          <div class="glass-panel q-pa-md dashboard-stagger-1">
            <div
          ...
          <div class="glass-panel q-pa-md dashboard-stagger-2">
            <div
              class="text-subtitle1 text-weight-medium q-mb-sm"
              style="color: var(--text-base)"
            >
          ...
          <div class="glass-panel q-pa-md dashboard-stagger-1">
            ...
            <div>
              <div
                ...
                style="color: var(--text-muted)"
              >
                {{ t('aboutLegalDisclaimerTitle') }}
              </div>
              <div
                class="text-caption text-weight-regular glass-panel q-pa-sm rounded-borders"
                style="color: var(--text-muted); background: var(--bg-subtle); line-height: 1.4"
              >
                {{ t('aboutLegalDisclaimerText') }}
              </div>
            </div>
          </div>
        </QTabPanel>
