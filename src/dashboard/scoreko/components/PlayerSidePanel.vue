...
const handleNameSave = () => {
  player.onNameSave();
  notifySuccess(t('scoreboardSavedLocally'));
};
  ...
  <div class="player-panel">
    ...
    <div class="player-panel__score-actions">
      <QBtn
        ...
        text-color="white"
        outline
        class="score-action-btn decrease-btn btn-active-scale"
        icon="remove"
        @click="adjustScore(-1)"
      >
        <QTooltip
      ...
      <div
        :key="score"
        class="score-display pulse-pop"
      >
        {{ score }}
      </div>
      <QBtn
        text-color="black"
        class="score-action-btn increase-btn btn-active-scale"
        icon="add"
        @click="adjustScore(1)"
      >
        <QTooltip
