  ...
  <div class="scoreboard-banner glass-panel">
    <div class="scoreboard-banner__side scoreboard-banner__side--left">
      <div class="scoreboard-banner__image-wrap">
        <img
          ...
          class="scoreboard-banner__image scoreboard-banner__image--left img-fade-in"
          alt=""
        >
      </div>
    ...
    <div class="scoreboard-banner__center">
      <div class="scoreboard-banner__score">
        <span
          :key="`left-${scoreboardStore.scoreboard.leftScore}`"
          class="score-value pulse-pop"
        >{{ scoreboardStore.scoreboard.leftScore }}</span>
        <span class="score-dash">-</span>
        <span
          :key="`right-${scoreboardStore.scoreboard.rightScore}`"
          class="score-value pulse-pop"
        >{{ scoreboardStore.scoreboard.rightScore }}</span>
      </div>
    </div>
    ...
    <div class="scoreboard-banner__side scoreboard-banner__side--right">
      ...
      <div class="scoreboard-banner__image-wrap">
        <img
          ...
          class="scoreboard-banner__image scoreboard-banner__image--right img-fade-in"
          alt=""
        >
      </div>
    </div>
